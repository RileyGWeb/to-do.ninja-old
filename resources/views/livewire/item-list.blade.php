    ...
    @foreach($items as $item)    
        <div class="flex" :wire:key="{{ $item->id }}">
            <form class="flex items-center mb-4">
                <input id="item_complete" type="checkbox" class="w-4 h-4 text-blue-600 bg-white rounded border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
